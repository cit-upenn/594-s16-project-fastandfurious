...
public class Controller {
	...
	protected void login() {
		...
		String[] times = { "60 sec", "90 sec", "120 sec", "150 sec", "180 sec", "210 sec", "240 sec", "300 sec", "600 sec" };
		...
		view.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent event) {
				...
				if(galaxy.getHumanPlayer() != null) {
					...
					// if node is not null and belongs to the other player
	...
	class MyActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == type1) {
				...
				JComboBox<String> cb = (JComboBox<String>) e.getSource();
				String selected = (String) cb.getSelectedItem();
				timeLimit = Integer.parseInt(selected.split("\\s+")[0]);
			}
		}	
	}
